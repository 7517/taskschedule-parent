...
import com.edison.saas.common.framework.web.data.SortCondition;
...
import com.edison.service.taskschedule.business.task.dto.TaskprogressAddDto;
import com.edison.service.taskschedule.business.task.dto.TaskprogressEditDto;
import com.edison.service.taskschedule.business.task.service.TaskprogressService;
import com.edison.service.taskschedule.business.task.valid.TaskprogressValidator;
import com.edison.service.taskschedule.business.task.vo.TaskprogressVO;
...
public class TaskprogressController {
	...
	public	TaskprogressVO update(@RequestBody @Valid TaskprogressEditDto taskprogressEditDto, @PathVariable Long id){
		Taskprogress taskprogress = new Taskprogress();
...
public List<TaskprogressVO> findByTaskId(Long taskId){
	...
	public Map<Boolean,String> updateTaskStatus() {
		Taskprogress taskprogresses = taskprogressService.updateTaskStatus(taskId, taskStatus);
		Map<Boolean,String> map=new HashMap<>();

		if (taskprogresses.getTaskStatus()!=null){
			map.put(true,"修改成功");
			return map;
		}
		map.put(false,"修改失败");
