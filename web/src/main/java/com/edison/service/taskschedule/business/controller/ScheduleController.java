...
import com.edison.service.taskschedule.business.service.ScheduleService;
import com.edison.service.taskschedule.business.valid.ScheduleValidator;
...
public class ScheduleController {
	...
	public Map addSchedule(@RequestBody ScheduleAddDto scheduleAddDto, @ApiParam(value = "单位为分钟") Long time){
	...
	public List<Map> findByDate(@RequestParam Date beginAt,@RequestParam String uid){
	...
	public ScheduleVO findScheduleDetails(@ApiParam(value = "日程主键id") Long id){
	...
	public ScheduleVO updateSchedule(@RequestBody ScheduleEditDto scheduleEditDto,@ApiParam(value = "提醒时间，单位为分钟")Long time, Long id){
		Schedule schedule=new Schedule();
		BeanUtils.copyProperties(scheduleEditDto,schedule);
