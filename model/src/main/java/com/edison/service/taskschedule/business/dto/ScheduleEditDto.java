 ...
 * @author icode
 */
@ApiModel(value = "修改日程使用的DTO")
@Setter @Getter
public class ScheduleEditDto extends BaseEntity<Long> {
	...
	/**日程详情*/
	@ApiModelProperty(value = "日程详情", required = false)
	...
	/**日程标题*/
	@ApiModelProperty(value = "日程标题", required = false)
