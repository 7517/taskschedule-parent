...
@Setter @Getter
public class TaskAddDto extends BaseEntity<Long> {
	...
	/**协助部门主任人名*/
	@ApiModelProperty(value = "协助部门主任人名", required = false,hidden = true)
	private String assDeptUidName;

	/**责任部门主任人名*/
	@ApiModelProperty(value = "责任部门主任人名", required = false,hidden = true)
	private String respDeptUidName;

	/**被指派人名*/
	@ApiModelProperty(value = "被指派人名", required = false,hidden = true)
